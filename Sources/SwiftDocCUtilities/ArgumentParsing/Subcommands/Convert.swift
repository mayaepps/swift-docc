...
extension Docc {
    ...
    public struct Convert: ParsableCommand {
        ...
        public mutating func validate() throws {
            ...
            if let versionDisplayNameOverride = versionDisplayNameOverride {
                print("Version display name: \(versionDisplayNameOverride)")
            }
            
            if let versionIdentifierOverride = versionIdentifierOverride {
                print("Version identifier: \(versionIdentifierOverride)")
            }
        }
